...
architecture structural of control is
   ...
   signal cnt : std_logic_vector(2 downto 0) := (others => '0');   -- Cycle counter
...
begin
   ...
   -- jyv 2026-07-11: was one 2008 if/elsif/else-generate chain -- rewritten
   -- as complementary VHDL-93 if-generates (Quartus Standard, vcom-1441).
   variant_gen_65c02 : if G_VARIANT = "65C02" generate
   ...
   end generate variant_gen_65c02;

   variant_gen_6502 : if G_VARIANT = "6502" generate
   ...
   end generate variant_gen_6502;

   variant_gen_bad : if G_VARIANT /= "65C02" and G_VARIANT /= "6502" generate
      bad_variant : process
      begin
         assert false report "Invalid G_VARIANT: " & G_VARIANT & ". Expected one of 65C02 or 6502" severity failure;
         wait;
      end process bad_variant;
   end generate variant_gen_bad;
