...
module sprite_line_buffer(
    ...
    // Upstream VERA source had each of these lines duplicated -- harmless on
    // Lattice Radiant (merges identical drivers), fatal on Quartus (rejects
    // multiple drivers per net).  Kept one copy of each.
